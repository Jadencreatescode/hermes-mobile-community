...
| Bot Mode | Bots tab, roster, Bot Chat, group chats, routines, New Agent | Interaction verified | Interaction verified | Layout verified | Layout verified | Layout verified | Existing Desktop interface | Fold outer browser contract opens the sidebar and Bots tab, verifies the Bot Mode workspace and New Agent control, and retains screenshot evidence. The bundled Bot Mode suite passes 362 tests. |
