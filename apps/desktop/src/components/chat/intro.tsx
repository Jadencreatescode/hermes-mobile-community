  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%_-_1rem)] [--fit-min:1.75rem] font-['Collapse'] font-bold uppercase leading-[0.9] tracking-[0.08em] text-midground mix-blend-plus-lighter sm:[--fit-min:2.75rem] dark:text-foreground/90"
        >
          <span>
            <span>{WORDMARK}</span>
          </span>
