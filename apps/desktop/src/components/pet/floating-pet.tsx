...
export function FloatingPet() {
  ...
  const narrowOverlay = useMediaQuery('(max-width: 639px)')
  ...
  if (!info.enabled || !info.spritesheetBase64 || overlayActive || (routeOverlayOpen && narrowOverlay)) {
    return null
  }

  return (
    <div
      data-slot="floating-pet"
