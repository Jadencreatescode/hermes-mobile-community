...
describe('composerStacksAtWidth', () => {
  it('stacks a Fold outer composer before controls overlap the input', () => {
    expect(composerStacksAtWidth(322)).toBe(true)
    expect(composerStacksAtWidth(340)).toBe(false)
  })
})
